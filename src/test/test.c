...
FuzzFIS_t flexnav;                                                                                     
/* I/O Fuzzy Objects */                                                                                
FuzzIO_t flexnav_inputs[4], flexnav_outputs[2];                                                        
/* I/O Membership Objects */                                                                           
FuzzMF_t MFin[12], MFout[6];                                                                           
/*  I/O Names */                                                                                       
enum { wt, dax, day, ae };                                                                             
...
int main(int argc, char** argv) {                                                                      
	...
	printf("flexnav_outputs[phit].value=%g flexnav_outputs[thetat].value=%g", flexnav_outputs[phit].value, flexnav_outputs[thetat].value);                                                                     
